...
import ayushi.view.adapter.ProductOverViewPagerAdapter;

/**
 * Created by lenovo on 28-01-2017.
 */

public class SaleOverviewFragment extends Fragment {
   ...
   // private KenBurnsView header;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_sale_overview,
                container, false);
