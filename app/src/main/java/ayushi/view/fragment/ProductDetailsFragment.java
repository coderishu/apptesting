...
import ayushi.model.entities.Money;
import ayushi.model.entities.Product;
import ayushi.util.ColorGenerator;
import ayushi.util.Utils;
import ayushi.util.Utils.AnimationType;
import ayushi.view.activities.ECartHomeActivity;
import ayushi.view.adapter.ProductsPagerAdapter;
import ayushi.view.customview.ClickableViewPager;
import ayushi.view.customview.ClickableViewPager.OnItemClickListener;
import ayushi.view.customview.LabelView;
import ayushi.view.customview.TextDrawable;
import ayushi.view.customview.TextDrawable.IBuilder;
