...
import ayushi.R;
import ayushi.domain.mock.FakeWebServer;
import ayushi.util.AppConstants;
import ayushi.util.Utils;
import ayushi.util.Utils.AnimationType;
import ayushi.view.activities.ECartHomeActivity;
import ayushi.view.adapter.CategoryListAdapter;
import ayushi.view.adapter.CategoryListAdapter.OnItemClickListener;
import ayushi.view.fragment.ActiviytySelectionFragment;
					...
					.SetOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(View view, int position) {
							...
							Utils.switchFragmentWithAnimation(
									R.id.frag_container,
									new ActiviytySelectionFragment(),
