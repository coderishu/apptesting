package ayushi.domain.mock;

import java.util.ArrayList;
import java.util.concurrent.ConcurrentHashMap;

import ayushi.model.GlobaDataHolder;
import ayushi.model.entities.Product;
import ayushi.model.entities.ProductCategoryModel;
...
public class FakeWebServer {
	...
	public void getAllElectronics() {
		...
		productlist
				.add(new Product(
						"Cooler",
						"IFB 17PMMEC1 17 L Solo Cooler",
						"Explore the joys of coolness with IFB 17PM MEC1 Solo Cooler. The budget-friendly appliance has several nifty features including Multi Power Levels and Speed Defrost to make cooking a fun-filled experience.",
						"5490",
						"10",
						"4290",
						"0",
						"http://www.worldblaze.in/wp-content/uploads/2015/05/Ram-Coolers.jpg",
						""));
		...
		productMap.put("Cooler", productlist);
		...
		tvList.add(new Product(
				"Beddings",
				"Vu 80cm (32) Bedding",
				"Enjoy movie night with the family on this 80cm Bed from Vu. With an A+ grade panel, this bed renders crisp details that make what you're watching look realistic.",
				"16000",
				"12",
				"13990",
				"0",
				"http://image.melodyhome.com/images/upload/2(310).jpg",
				""));
		...
		productMap.put("Beddings", tvList);
		...
		productlist
				.add(new Product(
						"Easy Study Plus Hand-held ",
						"Easy Study Plus Hand-held Books",
						"Book",
						"2699",
						"10",
						"2566",
						"0",
						"http://www.auromere.com/img-books.jpg",
						""));
		...
		productMap.put("Books", productlist);
	...
	public void getAllFurnitures() {
		...
		productMap.put("Gate", productlist);
